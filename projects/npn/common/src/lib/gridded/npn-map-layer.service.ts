...
export class NpnMapLayerService {
                        ...
                        case MapLayerType.PEST:
                            {
                                ...
                                || layerDef.name == 'gdd:monilinia'
                                || layerDef.name == 'gdd:slf_adult' 
                                || layerDef.name == 'gdd:slf_egg_hatch'
                                || layerDef.name == 'gdd:japanese_beetle_adult' 
                                || layerDef.name == 'gdd:japanese_beetle_egg_hatch'
    ...
    getLegend(input:MapLayerDefinition | string):Promise<MapLayerLegend> {
        ...
        return definition.then(layerDef => {
            ...
            || layerName == 'gdd:monilinia'
            || layerName == 'gdd:slf_adult' 
            || layerName == 'gdd:slf_egg_hatch' 
            || layerName == 'gdd:japanese_beetle_adult' 
            || layerName == 'gdd:japanese_beetle_egg_hatch' 
                ...
                .then(xml => {
                    ...
                    const userStyleElm = !!layerBasis
                        ? userStyles.toArray().reduce((found,e) => {
                                ...
                                || styleName == 'japanese_beetle_adult' 
                                || styleName == 'japanese_beetle_egg_hatch' 
